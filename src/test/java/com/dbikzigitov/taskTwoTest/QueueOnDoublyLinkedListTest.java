package com.dbikzigitov.taskTwoTest;

import com.dbikzigitov.tasktwo.QueueOnDoublyLinkedList;
...
public class QueueOnDoublyLinkedListTest {

    private QueueOnDoublyLinkedList<Integer> testQueue;
    private QueueOnDoublyLinkedList<Integer> emptyQueue;
    private int testSize;

    @BeforeEach
    public void setUp() {
        testQueue = new QueueOnDoublyLinkedList<>();
        emptyQueue = new QueueOnDoublyLinkedList<>();
        testSize = 3;
