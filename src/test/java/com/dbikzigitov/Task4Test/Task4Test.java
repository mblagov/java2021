package com.dbikzigitov.Task4Test;

import com.dbikzigitov.Task4Multithreading;
...
public class Task4Test {
    private final String numberPath = ".\\src\\test\\java\\com\\dbikzigitov\\Task4Test\\numbers.txt";
    private final String tangentsPath = ".\\src\\test\\java\\com\\dbikzigitov\\Task4Test\\tangents.txt";
    ...
    public void test1() throws Exception {
        List<Double> numList = generateNumbers(10);
        ...
        System.out.println("In single thread for 10 numbers: " + (end1 - start1) + " ms");
        System.out.println("In multi thread for 10 numbers: " + (end2 - start2) + " ms");
    }

    @Test
    public void test2() throws Exception {
        List<Double> numList = generateNumbers(10000);
        long start1, end1, start2, end2;
        ...
        System.out.println("In single thread for 10000 numbers: " + (end1 - start1) + " ms");
        System.out.println("In multi thread for 10000 numbers: " + (end2 - start2) + " ms");
    }

    @Test
    public void test3() throws Exception {
        List<Double> numList = generateNumbers(1000000);
        long start1, end1, start2, end2;
        ...
        System.out.println("In single thread for 1000000 numbers: " + (end1 - start1) + " ms");
        System.out.println("In multi thread for 1000000 numbers: " + (end2 - start2) + " ms");
    }
}
